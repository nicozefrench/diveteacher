...
class OllamaProvider(LLMProvider):
    ...
    async def stream_completion(
        ...
        try:
            ...
            logger.error("     - Ollama process stuck/crashed")
            logger.error("     - Model too large for available RAM")
            logger.error("     - CPU throttling")
            ...
            logger.error("   • Check Ollama service is running: docker ps | grep ollama")
